                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            <h5 class="widget-user-desc" style="margin-left: 0px">{php_open_tag_echo} cclang('new', ['<?= ucwords(clean_snake_case($subject)); ?>']); {php_close_tag}</h5>
                            <hr>
                        </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'number') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>'); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'email') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>'); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'date') {?><div class="form-group ">
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="<?= $input; ?>"  placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" id="<?= $input; ?>">
                            </div>
                            <small class="info help-block">
                            <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'address_map') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input autocomplete="off" type="text" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>'); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
