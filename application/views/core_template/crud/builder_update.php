                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            <h5 class="widget-user-desc" style="margin-left: 0px">Edit <?= ucwords($subject); ?></h5>
                            <hr>
                        </div>
                        ...
                        <?php foreach ($this->crud_builder->getFieldShowInUpdateForm(true) as $input => $option): ?> 
                        ...
                        <?php if ($option['input_type'] == 'input') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                        ...
                        <?php } elseif ($option['input_type'] == 'number') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'email') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
                        <?php } elseif ($option['input_type'] == 'datetime') {?><div class="form-group ">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="<?= $input; ?>"  placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" id="<?= $input; ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                            </div>
                            <small class="info help-block">
                            <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'password') {?><div class="form-group ">
                            ...
                            <div class="col-sm-6">
                              ...
                              <input type="password" class="form-control password" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="<?= set_value('<?= $input; ?>'); ?>">
                        ...
                        <?php } elseif ($option['input_type'] == 'textarea') { ?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <textarea id="<?= $input; ?>" name="<?= $input; ?>" rows="5" class="textarea">{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}</textarea>
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'date') {?><div class="form-group ">
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="<?= $input; ?>"  placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" id="<?= $input; ?>" value="{php_open_tag_echo} set_value('{table_name}_<?= $input; ?>_name', ${table_name}-><?= $input; ?>); {php_close_tag}">
                            </div>
                            <small class="info help-block">
                            <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        ...
                        ?><div class="form-group ">
                            ...
                            <div class="col-sm-2">
                                <select  class="form-control chosen chosen-select-deselect" name="<?= $input; ?>" id="<?= $input; ?>" data-placeholder="Select <?= ucwords(clean_snake_case($input)); ?>" >
                                    ...
                                    <option {php_open_tag_echo}  $i ==  ${table_name}-><?= $input; ?> ? 'selected' : ''; {php_close_tag} value="{php_open_tag_echo} $i; {php_close_tag}">{php_open_tag_echo} $i; {php_close_tag}</option>
                        ...
                        ?><div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    ?><div class="col-md-3 padding-left-0">
                                    <label>
                                    <input {php_open_tag_echo} ${table_name}-><?= $input; ?> == "<?= $option['value']; ?>" ? "checked" : ""; {php_close_tag} type="radio" class="flat-red" name="<?= $input; ?>" value="<?= $option['value']; ?>"> <?= $option['label']; ?>
                                    </label>
                                    </div>
                                    <?php endforeach; 
                                ?></select>
                        ...
                        ?><div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    ?><div class="col-md-3  padding-left-0">
                                    <label>
                                    <input {php_open_tag_echo} in_array('<?= $option['value']; ?>', explode(',', ${table_name}-><?= $input; ?>)) ? 'checked' : ''; {php_close_tag}  type="checkbox" class="flat-red" name="<?= $input; ?>[]" value="<?= $option['value']; ?>"> <?= $option['label']; ?>
                                    </label>
                                    </div>
                                    <?php endforeach; ?>
                                    <div class="row-fluid clear-both">
                        ...
                        ?><div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="<?= $input; ?>[]" id="<?= $input; ?>" data-placeholder="Select <?= ucwords(clean_snake_case($input)); ?>" multiple >
                                    <option value=""></option>
                                    <?php foreach ($custom_value as $option): 
                                    ?><option {php_open_tag_echo} in_array('<?= $option['value']; ?>', explode(',', ${table_name}-><?= $input; ?>)) ? 'selected' : ''; {php_close_tag}  value="<?= $option['value']; ?>"><?= $option['label']; ?></option>
                                    <?php endforeach; 
                                    ?></select>
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                        ...
                        ?><div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="<?= $input; ?>" id="<?= $input; ?>" data-placeholder="Select <?= ucwords(clean_snake_case($input)); ?>" >
                                    <option value=""></option>
                                    <?php foreach ($custom_value as $option): 
                                    ?><option {php_open_tag_echo} ${table_name}-><?= $input; ?> == "<?= $option['value']; ?>" ? 'selected' :''; ?> value="<?= $option['value']; ?>"><?= $option['label']; ?></option>
                                    <?php endforeach; 
                                ?></select>
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                        ...
                        <?php } elseif ($option['input_type'] == 'address_map') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input autocomplete="off" type="text" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
                        ...
                        <label for="<?= $input; ?>" class="col-sm-2 control-label"><?= ucwords(clean_snake_case($option['label'])); ?> 
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($option['label'])); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>'); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
