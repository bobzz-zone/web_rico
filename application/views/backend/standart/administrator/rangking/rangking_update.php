                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            <h5 class="widget-user-desc" style="margin-left: 0px">Edit Rangking</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/rangking/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_rangking', 
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_keyword" id="id_keyword" data-placeholder="Select Id Keyword" >
                                    ...
                                    <option <?=  $row->id ==  $rangking->id_keyword ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->keyword; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="rank" id="rank" placeholder="Rank" value="<?= set_value('rank', $rangking->rank); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <textarea id="website" name="website" rows="10" cols="80"> <?= set_value('website', $rangking->website); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="rating" id="rating" placeholder="Rating" value="<?= set_value('rating', $rangking->rating); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="viewer" id="viewer" placeholder="Viewer" value="<?= set_value('viewer', $rangking->viewer); ?>">
                                <small class="info help-block">
