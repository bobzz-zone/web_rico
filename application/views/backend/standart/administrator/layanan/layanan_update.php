                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            <h5 class="widget-user-desc" style="margin-left: 0px">Edit Layanan</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/layanan/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_layanan', 
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="id_pasien" id="id_pasien" placeholder="Pasien" value="<?= set_value('id_pasien', $layanan->id_pasien); ?>">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_kelas" id="id_kelas" data-placeholder="Select Id Kelas" >
                                    ...
                                    <option <?=  $row->id ==  $layanan->id_kelas ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->nama; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="lokasi" id="lokasi" placeholder="Lokasi" value="<?= set_value('lokasi', $layanan->lokasi); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_cara_bayar" id="id_cara_bayar" data-placeholder="Select Id Cara Bayar" >
                                    ...
                                    <option <?=  $row->id ==  $layanan->id_cara_bayar ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->nama; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#layanan_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
