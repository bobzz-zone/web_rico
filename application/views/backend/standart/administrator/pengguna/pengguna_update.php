                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            <h5 class="widget-user-desc" style="margin-left: 0px">Edit Pengguna</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/pengguna/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_pengguna', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="<?= set_value('nama', $pengguna->nama); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="telpon" id="telpon" placeholder="Telpon" value="<?= set_value('telpon', $pengguna->telpon); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_bpjs" id="no_bpjs" placeholder="No Bpjs" value="<?= set_value('no_bpjs', $pengguna->no_bpjs); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="email" id="email" placeholder="Email" value="<?= set_value('email', $pengguna->email); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_ktp" id="no_ktp" placeholder="No Ktp" value="<?= set_value('no_ktp', $pengguna->no_ktp); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat" value="<?= set_value('alamat', $pengguna->alamat); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="pengguna_image_uuid" id="pengguna_image_uuid" type="hidden" value="<?= set_value('pengguna_image_uuid'); ?>">
                                <input class="data_file" name="pengguna_image_name" id="pengguna_image_name" type="hidden" value="<?= set_value('pengguna_image_name', $pengguna->image); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#pengguna_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#pengguna_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/pengguna/get_image_file/<?= $pengguna->id; ?>',
