                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            <h5 class="widget-user-desc" style="margin-left: 0px">Edit Configuration</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/configuration/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="bg_color" id="bg_color" placeholder="Bg Color" value="<?= set_value('bg_color', $configuration->bg_color); ?>">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="configuration_banner_image_uuid" id="configuration_banner_image_uuid" type="hidden" value="<?= set_value('configuration_banner_image_uuid'); ?>">
                                <input class="data_file" name="configuration_banner_image_name" id="configuration_banner_image_name" type="hidden" value="<?= set_value('configuration_banner_image_name', $configuration->banner_image); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="configuration_logo_uuid" id="configuration_logo_uuid" type="hidden" value="<?= set_value('configuration_logo_uuid'); ?>">
                                <input class="data_file" name="configuration_logo_name" id="configuration_logo_name" type="hidden" value="<?= set_value('configuration_logo_name', $configuration->logo); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="bg_color_box_menu" id="bg_color_box_menu" placeholder="Bg Color Box Menu" value="<?= set_value('bg_color_box_menu', $configuration->bg_color_box_menu); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="bg_color_box_list" id="bg_color_box_list" placeholder="Bg Color Box List" value="<?= set_value('bg_color_box_list', $configuration->bg_color_box_list); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_configuration.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#configuration_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#configuration_banner_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/configuration/get_banner_image_file/<?= $configuration->id_configuration; ?>',
       ...
       $('#configuration_logo_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/configuration/get_logo_file/<?= $configuration->id_configuration; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
