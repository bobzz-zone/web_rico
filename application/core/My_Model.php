...
class MY_Model extends CI_Model {
    ...
    private $field_search;
		private $deleted_value = VALUE_DELETED;
	private $column_deleted = COLUMN_REFERENCE;
    ...
    {
			$data = [
				$this->column_deleted => $this->deleted_value
			];
    ...
    public function export($table, $subject = 'file')
    {
        ...
        {
            if($field != "add_by" && $field != "date_add" && $field != "deleted"  && $field != "id_nasabah"){
        ...
        foreach($result->result() as $data)
        {
            ...
            foreach ($fields as $field)
            {
				if($field != "add_by" && $field != "date_add" && $field != "deleted"){
