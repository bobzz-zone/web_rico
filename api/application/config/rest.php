...
$config['auth_override_class_method']['auth']['signup'] = 'none';
$config['auth_override_class_method']['auth']['signin'] = 'none';
$config['auth_override_class_method']['auth']['forgot_password'] = 'none';
$config['auth_override_class_method']['auth']['activation'] = 'none';
$config['auth_override_class_method']['auth']['signin_fb'] = 'none';
$config['auth_override_class_method']['auth']['signin_google'] = 'none';
...
$config['rest_tokens_column'] = 'token';
