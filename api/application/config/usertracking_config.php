...
| default: null
*/
$config['usertracking']['user_identifier'] = null;//array("model", "Crud_model2", "check_user", array("admin_login" => "yes"));
//$config['usertracking']['user_identifier'][] = array("model", "Crud_model2", "check_user_id", array("admin_login" => "yes"));
...
//$config['usertracking']['tracking_filter'][] = array('model','Crud_model2','is_has_admin_id',true);
