...
class Promoted_item_model extends CI_model
{
    public $table = 'promoted_item a'; // you MUST mention the table name
    ...
    public function get_all_count($where,$search){
      $this->db->select('a.id')
       ...
       if(!empty($search)){
         $this->db->where("(b.nama LIKE '%$search')");
       }
