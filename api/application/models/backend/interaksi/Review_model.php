...
{
    public $table = 'item_review a'; // you MUST mention the table name
    ...
    public function get_all($where,$search,$order,$limit,$offset){
      $this->db->select('a.id,a.tanggal,a.id_pengguna,a.id_item,a.id_transaksi,
                         a.foto,a.status,a.bintang,
